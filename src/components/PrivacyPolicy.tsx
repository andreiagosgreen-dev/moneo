  ...
  return (
    <div className="max-w-2xl mx-auto p-6 text-sm text-gray-700">
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          Cloud sync covers only focus sessions, focus areas and settings. Projects, tasks, plans,
          time blocks, goals, habits, journal and energy entries stay on your device.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          ...
          purposes. Your data is only used to provide the Moneo service.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          We use industry-standard encryption and security practices to protect your data. However,
