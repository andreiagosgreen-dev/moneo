...
const AGILE_TABS: Array<{ id: AgileTab; label: TKey }> = [
...
export default function AgileCard({
  ...
  return (
    <section className="card px-6 py-6 sm:px-7" aria-label={t('agile.ariaLabel')}>
      <header className="flex items-baseline justify-between gap-3">
        ...
        {live.length > 0 && (
          <select
            ...
            aria-label={t('agile.boardProjectLabel')}
          >
            {live.map((p) => (
