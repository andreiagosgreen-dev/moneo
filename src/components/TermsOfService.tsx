  ...
  return (
    <div className="max-w-2xl mx-auto p-6 text-sm text-gray-700">
      ...
      <section className="mb-6">
        ...
        <p className="mb-2">
          You retain ownership of your data. Moneo provides tools to export (CSV/PDF export
          is a Pro feature) and delete your data upon request. Cloud sync covers focus
          sessions, focus areas and settings via Supabase infrastructure, subject to their
          terms.
        </p>
      </section>
