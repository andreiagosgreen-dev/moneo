...
describe('buildWeeklyRecap', () => {
  it('aggregates totals, days, top projects and goals in motion', () => {
    const tasks: Task[] = [
      { id: 't1', projectId: 'p1', title: 'A', status: 'completed', priority: 'p1', createdAt: 1, updatedAt: 1 },
      { id: 't2', projectId: 'p1', title: 'B', status: 'pending', priority: 'p2', createdAt: 1, updatedAt: 1 },
      { id: 't3', projectId: 'p2', title: 'C', status: 'pending', priority: 'p2', createdAt: 1, updatedAt: 1 },
    ];
    const goals: Goal[] = [
